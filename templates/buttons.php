...
"#btn{$GLOBALS['counter']} {
    ...
    #btn{$GLOBALS['counter']} a:active{
    background-color: rgb(0%, 43%, 75%);
    -webkit-box-shadow: 0 0 0 2px rgba({$GLOBALS["bg-color"]}, 1), 0 0 0 4px rgb(11%, 63%, 95%);
    box-shadow: 0 0 0 2px rgba({$GLOBALS["bg-color"]}, 1), 0 0 0 4px rgb(11%, 63%, 95%);
    }",
...
"#btn{$GLOBALS['counter']} {
    ...
    text-decoration: none;
    font-weight: 500;
    color: rgba({$GLOBALS['tx-color']}, 0.5);
    font-family: sans-serif;
    border: 2px solid rgba({$GLOBALS['tx-color']}, 0.5);
    border-radius: 2px;
    transition: 0.3s ease-in-out;
    }
    ...
    top: 50%;
    bottom: 50%;
    background: rgba({$GLOBALS['tx-color']}, 1);
    z-index: -1;
    ...
    #btn{$GLOBALS['counter']} a:active{
        background-color: rgba({$GLOBALS['tx-color']}, 1);
        border: 2px solid rgba({$GLOBALS["bg-color"]}, 1);
    }",
...
"#btn{$GLOBALS['counter']} {
    ...
    #btn{$GLOBALS['counter']} a:hover,
    #btn{$GLOBALS['counter']} a:focus{
        border: 2px solid rgba({$GLOBALS['tx-color']}, 1);
    }",
